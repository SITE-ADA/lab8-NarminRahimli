...
@Tag(name = "Kurslar", description = "Kurs CRUD əməliyyatları və tələbə qeydiyyatı endpointləri")
public class CourseController {

    private final CourseService courseService;

    @PostMapping
    @Operation(summary = "Yeni kurs yarat", description = "Sistemdə yeni kurs yaradır.")
    ...
    @GetMapping
    @Operation(summary = "Bütün kursları göstər", description = "Sistemdə olan bütün kursları qaytarır.")
    public ResponseEntity<List<CourseResponseDto>> getAllCourses() {
        return ResponseEntity.ok(courseService.getAllCourses());
    }

    @GetMapping("/{id}")
    @Operation(summary = "ID ilə kursu tap", description = "Verilmiş ID-yə əsasən bir kurs qaytarır.")
    public ResponseEntity<CourseResponseDto> getCourseById(@PathVariable Long id) {
        return ResponseEntity.ok(courseService.getCourseById(id));
    }

    @PutMapping("/{id}")
    @Operation(summary = "Kursu yenilə", description = "Verilmiş ID-yə əsasən kurs məlumatlarını yeniləyir.")
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Kursu sil", description = "Verilmiş ID-yə əsasən kursu silir.")
    ...
    @Operation(
            ...
            description = "Tələbəni kursa qeyd edir və tələbə məlumatlarını student-service vasitəsilə yoxlayır."
    )
    ...
    @Operation(
            summary = "Kurs tələbələrini göstər",
            description = "Kursa qeydiyyatdan keçmiş tələbələrin məlumatlarını qaytarır."
    )
